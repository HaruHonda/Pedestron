...
data_root = '/home/honda/Pedestron_cuda11/datasets/EuroCity/'
img_norm_cfg = dict(
...
log_level = 'INFO'
work_dir = './work_dirs/eurocity_cascade_rcnn_tb_x101_32x4d_fpn_1x_step_lr002_gpus1_finetune_wp_epoch9_img_scale_1920x1024'
load_from = './work_dirs/WiderPedestrian_cascade_rcnn_tb_x101_32x4d_fpn_1x_step_lr002_gpus1/stu_epoch_9.pth'
resume_from = None
workflow = [('train', 1)]
