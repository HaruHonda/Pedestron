...
data_root = '/home/honda/Pedestron_cuda11/datasets/CrowdHuman/'
img_norm_cfg = dict(
...
log_level = 'INFO'
work_dir = './work_dirs/crowdhuman_cascade_rcnn_hrnetv2p_w32_8'
load_from = None
resume_from = None
#resume_from = '/home/honda/Pedestron_cuda11/work_dirs/crowdhuman_cascade_rcnn_hrnetv2p_w32/epoch_2.pth'
workflow = [('train', 1)]